(function(Dn,v){typeof exports=="object"&&typeof module!="undefined"?v(exports,require("vue"),require("@floating-ui/dom")):typeof define=="function"&&define.amd?define(["exports","vue","@floating-ui/dom"],v):(Dn=typeof globalThis!="undefined"?globalThis:Dn||self,v(Dn.index={},Dn.Vue,Dn.dom))})(this,function(Dn,v,Ve){"use strict";const xo={modelValue:{type:Boolean,default:!1},lockScroll:{type:Boolean,default:!0},closeOnClickOverlay:{type:Boolean,default:!0}};function mo(){if(document.documentElement.scrollHeight>document.documentElement.clientHeight){const x=document.documentElement.scrollTop,y=document.documentElement.getAttribute("style");return document.documentElement.style.position="fixed",document.documentElement.style.top=`-${x}px`,document.documentElement.style.width=document.documentElement.style.width||"100%",document.documentElement.style.overflowY="scroll",()=>{y?document.documentElement.setAttribute("style",y):document.documentElement.removeAttribute("style"),document.documentElement.scrollTop=x}}}function yo(x,y){let o;const N=D=>{D.preventDefault(),y.emit("click",D),x.closeOnClickOverlay&&y.emit("update:modelValue",!1)},O=()=>{o==null||o()};return v.watch(()=>x.modelValue,D=>{D?x.lockScroll&&(o=mo()):O()}),v.onUnmounted(O),{onClick:N}}function vt(x,y,o){let N=x;return y&&(N+=`__${y}`),o&&(N+=`--${o}`),N}function Se(x,y=!1){const o=y?`.devui-${x}`:`devui-${x}`;return{b:()=>vt(o),e:G=>G?vt(o,G):"",m:G=>G?vt(o,"",G):"",em:(G,H)=>G&&H?vt(o,G,H):""}}var M0="";v.defineComponent({name:"DFixedOverlay",inheritAttrs:!1,props:xo,emits:["update:modelValue","click"],setup(x,y){const{modelValue:o}=v.toRefs(x),N=Se("fixed-overlay"),{onClick:O}=yo(x,y);return()=>v.createVNode(v.Transition,{name:N.m("fade")},{default:()=>{var D,I;return[o.value&&v.createVNode("div",v.mergeProps({class:N.b()},y.attrs,{onClick:O}),[(I=(D=y.slots).default)==null?void 0:I.call(D)])]}})}});const Ao={modelValue:{type:Boolean,default:!1},origin:{type:Object,require:!0},position:{type:Array,default:["bottom"]},offset:{type:[Number,Object],default:8},shiftOffset:{type:Number},align:{type:String,default:null},showArrow:{type:Boolean,default:!1},isArrowCenter:{type:Boolean,default:!0},clickEventBubble:{type:Boolean,default:!1}};function Eo(x){const y=/(auto|scroll|hidden)/;for(let o=x;o=o.parentElement;o.parentElement!==document.body){const N=window.getComputedStyle(o);if(y.test(N.overflow+N.overflowX+N.overflowY))return o}return window}function Lo(x,y,o,N){let{x:O,y:D}=y;if(!x){const{width:I,height:G}=N;O&&o.includes("start")&&(O=12),O&&o.includes("end")&&(O=Math.round(I-24)),D&&o.includes("start")&&(D=10),D&&o.includes("end")&&(D=G-14)}return{x:O,y:D}}function Co(x,y){const o=v.ref(),N=v.ref();let O=null;const D=(G,H,rn,q)=>{const{x:J,y:cn}=Lo(x.isArrowCenter,rn,H,q.getBoundingClientRect()),ln={top:"bottom",right:"left",bottom:"top",left:"right"}[H.split("-")[0]];Object.assign(G.style,{left:J?`${J}px`:"",top:cn?`${cn}px`:"",right:"",bottom:"",[ln]:"-4px"})},I=async()=>{const G=x.origin,H=v.unref(o.value),rn=v.unref(N.value),q=[Ve.offset(x.offset),Ve.autoPlacement({alignment:x.align,allowedPlacements:x.position})];x.showArrow&&q.push(Ve.arrow({element:rn})),x.shiftOffset!==void 0&&q.push(Ve.shift());const{x:J,y:cn,placement:ln,middlewareData:dn}=await Ve.computePosition(G,H,{strategy:"fixed",middleware:q});let yn=J,j=cn;if(x.shiftOffset!==void 0){const{x:_n,y:In}=dn.shift;_n<0&&(yn-=x.shiftOffset),_n>0&&(yn+=x.shiftOffset),In<0&&(j-=x.shiftOffset),In>0&&(j+=x.shiftOffset)}y("positionChange",ln),Object.assign(H.style,{top:`${j}px`,left:`${yn}px`}),x.showArrow&&D(rn,ln,dn.arrow,H)};return v.watch(()=>x.modelValue,()=>{x.modelValue&&x.origin?(O=Eo(x.origin),v.nextTick(I),O==null||O.addEventListener("scroll",I),O!==window&&window.addEventListener("scroll",I),window.addEventListener("resize",I)):(O==null||O.removeEventListener("scroll",I),O!==window&&window.removeEventListener("scroll",I),window.removeEventListener("resize",I))}),v.onUnmounted(()=>{O==null||O.removeEventListener("scroll",I),O!==window&&window.removeEventListener("scroll",I),window.removeEventListener("resize",I)}),{arrowRef:N,overlayRef:o,updatePosition:I}}var W0="";const Ro=v.defineComponent({name:"DFlexibleOverlay",inheritAttrs:!1,props:Ao,emits:["update:modelValue","positionChange"],setup(x,{slots:y,attrs:o,emit:N,expose:O}){const D=Se("flexible-overlay"),{clickEventBubble:I}=v.toRefs(x),{arrowRef:G,overlayRef:H,updatePosition:rn}=Co(x,N);return O({updatePosition:rn}),()=>{var q;return x.modelValue&&v.createVNode("div",v.mergeProps({ref:H,class:D.b()},o,{onClick:v.withModifiers(()=>({}),[I.value?"":"stop"]),onPointerup:v.withModifiers(()=>({}),["stop"])}),[(q=y.default)==null?void 0:q.call(y),x.showArrow&&v.createVNode("div",{ref:G,class:D.e("arrow")},null)])}}}),Wi=Symbol("popper-trigger"),So=x=>x!==null&&typeof x=="object",Io=Se("popper-trigger");function Ni(x){return v.h("span",{class:Io.b()},x)}function Di(x){for(const y of x){if(So(y)){if(y.type===v.Comment)continue;return y.type==="svg"||y.type===v.Text?Ni(y):y.type===v.Fragment?Di(y.children):y}return Ni(y)}return null}var To=v.defineComponent({name:"DPopperTrigger",setup(x,y){const{slots:o,attrs:N}=y;return()=>{var G;const O=(G=o.default)==null?void 0:G.call(o,N),D=v.inject(Wi);if(!O)return null;const I=Di(O);return I?v.withDirectives(v.cloneVNode(I,N),[[{mounted(H){D.value=H},updated(H){D.value=H},unmounted(){D.value=null}}]]):null}}});const Fi={isOpen:{type:Boolean,default:!1},position:{type:Array,default:["bottom"]},align:{type:String,default:null},offset:{type:[Number,Object],default:8},content:{type:String,default:""},trigger:{type:String,default:"click"},popType:{type:String,default:"default"},showAnimation:{type:Boolean,default:!0},mouseEnterDelay:{type:Number,default:150},mouseLeaveDelay:{type:Number,default:100},disabled:{type:Boolean,default:!1}};var Ze=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{},wt={exports:{}};/**
 * @license
...
`;else if(vl.test(L))throw new R(G);_=(c?_.replace(el,""):_).replace(tl,"$1").replace(rl,"$1;"),_="function("+(L||"obj")+`) {
`+(L?"":`obj || (obj = {});
